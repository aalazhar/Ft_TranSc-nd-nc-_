...
const chatSlice = createSlice({
  ...
  reducers: {
    addNewConv: (state, action: PayloadAction<{Conversation: Conversation}>) => {
      const len = action.payload.Conversation?.messages.length;
    ...
    ConversationsUpdate: (state, action: PayloadAction<Conversation[]>) => {
...
export const { addMessage, addNewConv, ConversationsUpdate, clearConversations } = chatSlice.actions;