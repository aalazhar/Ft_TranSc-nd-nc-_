...
class GameClass {
    ...
    constructor(element: HTMLDivElement, map: string, mod: string, gameId: string, socket?: Socket){
        ...
        this.generateObs();
        Events.on(this.engine, 'beforeUpdate', this.updatePaddlePosition)
        if (mod === "BOT"){
            this.Id = 2;
            this.createWorld();
            Events.on(this.engine, "collisionStart", this.handleCollition)
            Events.on(this.engine, "beforeUpdate",this.handleBotMovement)
            Events.on(this.engine , "afterUpdate",this.handleBallOut)
    ...
    private handleBallOut = (event : any)=>{
    ...
    private handleBotMovement = (event : any)=>{
    ...
    private updatePaddlePosition = (event : any)=>{
    ...
    private handleCollition = (event : any)=>{
    ...
    public  setLeftPressed(): void {
        this.leftPressed = true;
        this.rightPressed = false;
    }
    
    public  setRightPressed(): void {
        this.leftPressed = false;
        this.rightPressed = true;
    }
    public  setFalsePressed(): void {
        this.leftPressed = false;
        this.rightPressed = false;
    }

    public destroyGame(){
        Events.off(this.engine, "beforeUpdate", this.updatePaddlePosition);
        if (this.mod === "BOT"){
            Events.off(this.engine, "afterUpdate" , this.handleBallOut);
            Events.off(this.engine, "beforeUpdate", this.handleBotMovement);
            Events.off(this.engine, "collisionStart", this.handleCollition);
        }
        this.state = false;
        Runner.stop(this.runner);
