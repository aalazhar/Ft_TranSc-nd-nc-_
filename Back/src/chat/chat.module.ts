...
@Module({
    imports :[],
    providers: [UsersRepository, PrismaService, FriendsRepository, InvitesRepository,ChatGateway,  MatchesRepository, messageRepository, converationRepositroy, PrismaService, AchievementRepository, InvitesRepository, UserService, ChannelsService, ChannelGateway],
